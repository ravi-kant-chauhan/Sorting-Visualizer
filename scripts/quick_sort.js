...
function Quick()
{
    ...
    // Setting details
    document.getElementById("details").innerHTML="QuickSort is a sorting algorithm based on the Divide and Conquer algorithm that picks an element as a pivot and partitions the given array around the picked pivot by placing the pivot in its correct position in the sorted array."

    const linkElement = document.getElementById("reference")
    linkElement.setAttribute('href', "https://www.geeksforgeeks.org/quick-sort/")
